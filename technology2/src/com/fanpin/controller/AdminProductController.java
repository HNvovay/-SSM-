...
public class AdminProductController {
    ...
    * */
    ...
    public ModelAndView searchPro(
        ...
        view.setViewName("backstage/pro_search");
        return view;
    }
    @ResponseBody
    @RequestMapping(value = "serchPro1", produces = "application/json;charset=UTF-8")
    public Map<String, Object> serchPro1() {
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("pro_serch_list", Serchlist);
        return map;
    }
}
