...
public class OrderSvcIMPL implements IOrderSvc {
    ...
    @Override
    public OrderDetail selOrderSount(Integer orderid) {
        OrderDetail orderDetail = orderDao.selOrderSount(orderid);
        return orderDetail;
    }

    @Override
    public int upProStock(Integer pid, Integer odetailnum) {
        int i = orderDao.upProStock(pid, odetailnum);
        return i;
    }
}
