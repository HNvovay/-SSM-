                                                    ...
                                                    <div class="col-sm-10">
                                                        <c:if test="${!empty myinfo.phone }" var="phone">
                                                            <input type="text" class="form-control" id="phone"
                                                                   maxlength="11" onkeyup="this.value=this.value.replace(/[^0-9_]/g,'');"
                                                                   name="phone"
                                                                   placeholder="${myinfo.phone }" autocomplete="off">
                                                        </c:if>
                                                        <c:if test="${not phone }">
                                                            <input type="text" maxlength="11" onkeyup="this.value=this.value.replace(/[^0-9_]/g,'');" class="form-control" id="phone"
                                                                   name="phone"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <c:if test="${!empty myinfo.email }" var="email">
                                                            <input type="email" class="form-control" id="email"
                                                                   ...
                                                                   placeholder="${myinfo.email.replaceAll("@.*","") }" autocomplete="off">
                                                        </c:if>
                                                        <c:if test="${not email }">
                                                            <input type="email" onkeyup="this.value=this.value.replace(/[^a-z0-9_]/g,'');" class="form-control" id="email"
                                                                   name="email"
                                                                   placeholder="请添加您的邮箱" autocomplete="off">
                                                        </c:if>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <select name="emailsuffix" class="form-control">
                                                            <option value="@qq.com" >@qq.com</option>
                                                            <option value="@163.com" <c:if test="${myinfo.email.contains('@163.com')}">selected</c:if>>@163.com</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group" style="width: 130px">
