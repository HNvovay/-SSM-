...
public class UserController {
    ...
    public Map<String, Object> upUserInfo(
            ...
            @RequestParam(defaultValue = "",required = false) String emailsuffix,
        ...
        if (file != null) {
            ...
            //如果不是默认图片则删除
            if (!oldHeadimgPath.equals("person.jpg")) {
                //拿到图片地址，把本地图片删除
        ...
        if (user.getEmail().equals("")){
            if (!old_user.getEmail().contains(emailsuffix)){
                if (!old_user.getEmail().contains("@")){
                    user.setEmail(old_user.getEmail()+emailsuffix);
                }else {
                    String email=old_user.getEmail().replaceAll("@.*",emailsuffix);
                    user.setEmail(email);
                }
            }else
            ...
            if (user.getEmail().contains("@")){
                String email=user.getEmail().replaceAll("@.*",emailsuffix);
                user.setEmail(email);
            }else
