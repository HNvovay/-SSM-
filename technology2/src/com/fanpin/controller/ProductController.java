...
public class ProductController {
    ...
    public String newpro(HttpServletRequest request){
        List<Product> list=productSvc.selNumProduct();
        request.setAttribute("myphone", list);
        return "product";
    }
    /*
     * 热销单品
     */
    @RequestMapping(value="/hotpro")
    public String hotpro(HttpServletRequest request){
        List<Product> list=productSvc.selHotProduce();
        request.setAttribute("myphone", list);
        return "product";
    }
    ...
    public ModelAndView productinfo(
        ...
        view.addObject("commentlist",commentSvc.selCommentListByPid(pid));
        view.addObject("uid",UserUtil.getLoginUserId());
